 ...
 */
static char *font = "Inconsolata Regular:size=8:antialias=true:autohint=false:family=mono";
...
static char *openurlcmd[] = { "/bin/sh", "-c",
	"xurls | tac | dmenu -l 10 -w $WINDOWID | xargs -r xdg-open",
	"externalpipe", NULL };
static char *listdcccmd[] = { "/bin/sh", "-c",
	"grep -F '/MSG' | dmenu -i -l 10 -w $WINDOWID | xdcc | xsel -ib",
	"externalpipe", NULL };
